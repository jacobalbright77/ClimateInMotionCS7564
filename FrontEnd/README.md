...
2 Linked visualizations like stacked area, line, pie, and stripe charts that update based on selected countries
Tooltip support and a Celsius/Fahrenheit toggle for flexible viewing
...
This was built as a class project and is intended for demo and educational use only.
